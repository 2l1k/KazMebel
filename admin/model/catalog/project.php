...
class ModelCatalogProject extends Model {
	public function addProject($data) {
		...
		if (isset($data['product_image'])) {
			foreach ($data['product_image'] as $product_image) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_image SET product_id = '" . (int)$product_id . "', image = '" . $this->db->escape($product_image['image']) . "', title = '" . $this->db->escape($product_image['title']) . "', year = '" . $this->db->escape($product_image['year']) . "', sort_order = '" . (int)$product_image['sort_order'] . "'");
			}
		}
	...
	public function editProject($product_id, $data) {
	...
	public function copyProject($product_id) {
	...
	public function deleteProject($product_id) {
	...
	public function getProject($product_id) {
